...
const mockVoiceNotes: VoiceNote[] = [
    {
        id: 'vn-1',
        title: 'Meeting with Ahmad Al Maktoum - IPO Discussion',
        duration: 245,
        recordedAt: '2024-12-21T10:30:00',
        transcriptStatus: 'completed',
        transcript: `Good morning Ahmad, congratulations on the IPO filing. I wanted to discuss your post-IPO wealth management strategy. Based on our analysis, you'll have approximately ${formatCroreToUSD(180)} in liquid assets after the lock-in period expires. I recommend a diversified approach with 40% in PMS, 30% in alternative investments, and 30% in fixed income. We should also discuss tax optimization strategies to minimize capital gains tax. What are your thoughts on this allocation?`,
        language: 'en',
        linkedClients: ['Ahmad Al Maktoum'],
        detectedTopics: ['IPO', 'Wealth Management', 'PMS', 'Alternative Investments', 'Tax Optimization'],
        aiSummary: `Discussed post-IPO wealth management strategy with Ahmad Al Maktoum. Proposed diversified allocation: 40% PMS, 30% alternative investments, 30% fixed income. Estimated liquid assets: ${formatCroreToUSD(180)}. Client interested in tax optimization strategies.`,
        actionItems: [
    ...
    {
        id: 'vn-2',
        title: 'Call with Amal Al Sabah - Alternative Investments',
        duration: 180,
        recordedAt: '2024-12-21T14:15:00',
        transcriptStatus: 'completed',
        transcript: 'Hi Amal, thank you for taking my call. I wanted to discuss the alternative investment opportunities we talked about last week. We have three PE funds that match your risk profile - Wamda Capital Growth Fund, MEVP Fund III, and Dubai Angel Investors Fund II. The minimum ticket size is $5 million per fund. These funds have historically delivered 22-28% IRR. Would you like me to send detailed information packs?',
        language: 'en',
        linkedClients: ['Amal Al Sabah'],
        detectedTopics: ['Alternative Investments', 'PE Funds', 'Risk Profile', 'IRR'],
        aiSummary: 'Discussed alternative investment opportunities with Amal Al Sabah. Presented 3 PE funds: Wamda Capital, MEVP, Dubai Angel Investors. Minimum ticket: $5 Million per fund. Historical IRR: 22-28%. Client requested detailed information packs.',
        actionItems: [
            'Send PE fund information packs to Amal',
    ...
    {
        id: 'vn-3',
        title: 'Re-engagement Call - Rashid Al Falasi',
        duration: 120,
        recordedAt: '2024-12-21T16:00:00',
        transcriptStatus: 'completed',
        transcript: 'Hello Rashid, I hope you\'re doing well. I noticed we haven\'t connected in a while and wanted to check in. I saw your LinkedIn post about structured products - we have some new offerings that might interest you. Our new equity-linked structured notes offer 12-15% returns with capital protection. Would you be open to a quick coffee meeting next week to discuss?',
        language: 'en',
        linkedClients: ['Rashid Al Falasi'],
        detectedTopics: ['Re-engagement', 'Structured Products', 'Equity-Linked Notes', 'Capital Protection'],
        aiSummary: 'Re-engagement call with Rashid Al Falasi after 32-day gap. Discussed new structured product offerings. Equity-linked notes with 12-15% returns and capital protection. Client open to coffee meeting next week.',
        actionItems: [
    ...
    {
        id: 'vn-4',
        title: 'Arabic Conversation - Ali Al Saud',
        duration: 195,
        recordedAt: '',
        transcriptStatus: 'completed',
        transcript: 'As-salamu alaykum Ali, your portfolio is performing excellently. This quarter we achieved 6.5% returns. I wanted to discuss alternative investment opportunities with you. PE and VC funds can provide you with 20-25% returns. Would you like to discuss this further?',
        language: 'en',
        linkedClients: ['Ali Al Saud'],
        detectedTopics: ['Portfolio Performance', 'Alternative Investments', 'PE/VC Funds', 'Returns'],
        aiSummary: 'Conversation with Ali Al Saud. Discussed strong portfolio performance (6.5% quarterly returns). Introduced alternative investments opportunity (PE/VC funds with 20-25% potential returns). Client interested in further discussion.',
        actionItems: [
