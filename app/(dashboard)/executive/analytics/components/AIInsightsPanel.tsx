...
const mockExecutiveInsights: AIInsight[] = [
    ...
    },
    {
        ...
        description: 'Predictive model identifies 34 PMS clients with high propensity for structured products based on risk profile, portfolio composition, and investment behavior. Estimated additional revenue: $45M.',
        impact: 'medium',
        confidence: 84,
        actionable: true,
