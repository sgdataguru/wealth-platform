                        ...
                        <div className="flex items-start justify-between mb-4">
                            ...
                            <div className="text-right">
                                ...
                                <p className="text-lg font-bold text-[#1A1A2E]">
                                    {formatCroreAmount(prospect.estimatedNetWorth / 10_000_000)}
                                </p>
                                <p className="text-xs text-[#E85D54] font-medium mt-1">
                                    Target: {formatCroreAmount(prospect.totalExpectedAUM / 10_000_000)}
                                </p>
                            </div>
                        </div>
                                        ...
                                        <div className="flex items-start justify-between mb-2">
                                            ...
                                            <div className="text-right ml-4">
                                                <p className="text-sm font-bold text-[#1A1A2E]">
                                                    {formatCroreAmount(product.expectedAllocation / 10_000_000)}
                                                </p>
                                            </div>
                                        </div>
                                    </div>
