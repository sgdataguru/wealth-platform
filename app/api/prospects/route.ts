...
const mockProspects: Prospect[] = [
    ...
    signals: [
      {
        ...
        severity: 'critical',
        title: 'IPO Filing',
        description: 'Filed prospectus with UAE SCA',
      ...
      },
      {
        ...
        description: 'Raised $65M led by Mubadala Capital',
  ...
  },
  {
    ...
    initials: 'HA',
    title: 'Founder & CEO',
    company: 'Najd GreenEnergy Solutions',
    location: 'Riyadh',
    sector: 'Clean Energy',
    network: 'EO',
  ...
  },
  {
    ...
    company: 'Retail Dynamics GCC',
    location: 'Dubai',
    sector: 'Retail',
    network: 'GCC Family Office Council',
    email: 'noor@retaildynamics.ae',
  ...
  },
  {
    ...
    initials: 'KA',
    title: 'Co-founder',
    company: 'HealthTech Ventures ME',
    location: 'Doha',
    sector: 'Healthcare',
    network: 'EO',
    email: 'khalifa@healthtech.qa',
    phone: '+974 55 678 9012',
    leadScore: 75,
    scoreCategory: 'good',
    scoreBreakdown: [
