...
export default function Header({ userName, userInitials }: HeaderProps) {
  ...
  return (
    <header className="h-20 px-8 flex items-center justify-between sticky top-0 z-50 bg-gradient-to-r from-[#070b15] via-[#0c1324] to-[#0a0f1e] border-b border-[rgba(217,180,114,0.28)] shadow-[0_18px_40px_rgba(0,0,0,0.45)]">
      {/* Logo */}
