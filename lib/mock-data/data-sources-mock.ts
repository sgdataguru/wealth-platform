...
export const mockDataSources: DataSource[] = [
  ...
  },
  {
    ...
    nextSync: new Date(Date.now() + 11 * 60 * 1000),
    reliability: 98,
    uptime: 99.7,
    errorRate: 0.3,
    averageLatency: 180,
  ...
  },
  {
    ...
    nextSync: new Date(Date.now() + 9 * 60 * 1000),
    reliability: 97,
    uptime: 99.4,
    errorRate: 0.6,
    averageLatency: 200,
  ...
  },
  {
    ...
    nextSync: new Date(Date.now() + 18 * 60 * 1000),
    reliability: 90,
    uptime: 97.5,
    errorRate: 2.5,
    averageLatency: 850,
...
export const mockDataConflicts: DataConflict[] = [
  {
    ...
    suggestedResolution: {
      value: 250000000,
      reasoning: 'Argaam has higher reliability (94 vs 85) and confidence score (85 vs 65)',
    },
    status: 'pending',
  ...
  },
  {
    ...
    suggestedResolution: {
      value: 'Managing Director',
      reasoning: 'Zawya (LSEG) data from official regulatory filings (reliability: 97)',
    },
    status: 'pending',
  ...
  },
  {
    ...
    suggestedResolution: {
      value: 5000000000,
      reasoning: 'Tadawul official filing data (reliability: 99, confidence: 99)',
    },
    status: 'resolved',
