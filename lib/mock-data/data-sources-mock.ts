...
export interface RegistryEvent {
  ...
  details: {
    directors: { name: string; registryId: string }[];
    shareCapital: number;
    filingDate: Date;
  };
...
export const mockDataConflicts: DataConflict[] = [
  ...
  },
  {
    id: 'conflict-002',
    entityType: 'person',
    entityId: 'person-faisal-al-nuaimi',
    field: 'company_role',
    conflictingValues: [
      {
        source: 'UAE Ministry of Economy',
    ...
    suggestedResolution: {
      value: 'Managing Director',
      reasoning: 'UAE Ministry of Economy registry filings (reliability: 95)',
    },
    status: 'pending',
  ...
  },
  {
    ...
    suggestedResolution: {
      value: 5000000000,
      reasoning: 'DFM official filing data (reliability: 98, confidence: 99)',
    },
    status: 'resolved',
...
export const mockAuditLogs: AuditLog[] = [
  ...
  {
    id: 'log-002',
    sourceId: 'uae-registry',
    sourceName: 'UAE Ministry of Economy',
    action: 'sync',
    status: 'success',
    recordsProcessed: 89,
    errors: [],
  ...
  },
  {
    ...
    status: 'failure',
    recordsProcessed: 0,
    errors: ['Connection timeout after 30 seconds', 'Failed to reach moe.gov.ae registry endpoint'],
...
export const mockPrivateCircleEvents: PrivateCircleEvent[] = [
  {
    companyName: 'Harbor Tech Solutions LLC',
    funding: {
      round: 'Series B',
    ...
    investors: ['Mubadala Capital', 'STV', 'Wa\'ed Ventures'],
    promoters: ['Faisal Al-Nuaimi', 'Noor Al-Muhairi'],
    source: 'PrivateCircle',
    sourceId: 'pc-deal-12345',
    confidence: 88,
  },
  {
    companyName: 'Desert Solar Innovations',
    funding: {
      round: 'Series A',
    ...
    investors: ['Aramco Ventures', 'Gulf Capital', 'QIA'],
    promoters: ['Hassan Al-Rashid', 'Aisha Al-Farsi'],
    source: 'PrivateCircle',
    sourceId: 'pc-deal-12346',
    confidence: 85,
  },
  {
    companyName: 'GulfPay Services',
    funding: {
      round: 'Pre-IPO',
    ...
    investors: ['ADQ', 'Gulf International Bank', 'Investcorp'],
    promoters: ['Khalid Al-Mansouri', 'Layla Al-Fahim', 'Yousef Al-Khatib'],
    source: 'PrivateCircle',
    sourceId: 'pc-deal-12347',
    confidence: 92,
  },
  {
    companyName: 'HealthTech Diagnostics ME',
    funding: {
      round: 'Series C',
    ...
    investors: ['Saudi Aramco VC', 'Gulf Capital', 'Jadwa Investment'],
    promoters: ['Dr. Layla Al-Fahim', 'Omar Al-Hassan'],
    source: 'PrivateCircle',
    sourceId: 'pc-deal-12348',
    confidence: 87,
  },
  {
    companyName: 'EduBridge Learning Platform',
    funding: {
      round: 'Seed',
    ...
    promoters: ['Mariam Al-Zahra', 'Tariq Al-Hakim'],
    source: 'PrivateCircle',
...
// ==============================================
// MOCK DATA: GCC REGISTRY EVENTS
// ==============================================

export const mockRegistryEvents: RegistryEvent[] = [
  {
    companyName: 'Dubai Infra Developers LLC',
    registrationNumber: 'CN-110245-DXB',
    eventType: 'director_change',
    details: {
      directors: [
        { name: 'Faisal Al-Nuaimi', registryId: 'REG-001245' },
        { name: 'Noor Al-Muhairi', registryId: 'REG-002356' },
        { name: 'Omar Al-Hassan', registryId: 'REG-003478' },
      ],
      shareCapital: 500000000, // $50 Million
      filingDate: new Date('2025-12-14'),
    },
    source: 'UAE Ministry of Economy',
    sourceUrl: 'https://www.moe.gov.ae/en/companies-registry/cn-110245-dxb',
    confidence: 95,
  },
  {
    companyName: 'Abu Dhabi Real Estate Holdings LLC',
    registrationNumber: 'CN-204511-AUH',
    eventType: 'share_transfer',
    details: {
      directors: [
        { name: 'Aisha Al-Farsi', registryId: 'REG-004567' },
        { name: 'Khalid Al-Mansouri', registryId: 'REG-005678' },
      ],
      shareCapital: 750000000, // $75 Million
      filingDate: new Date('2025-12-12'),
    },
    source: 'UAE Ministry of Economy',
    sourceUrl: 'https://www.moe.gov.ae/en/companies-registry/cn-204511-auh',
    confidence: 93,
  },
  {
    companyName: 'Sharjah Tech Ventures LLC',
    registrationNumber: 'CN-330198-SHJ',
    eventType: 'filing',
    details: {
      directors: [
        { name: 'Maha Al-Suwaidi', registryId: 'REG-006789' },
        { name: 'Yousef Al-Khatib', registryId: 'REG-007890' },
        { name: 'Layla Al-Fahim', registryId: 'REG-008901' },
      ],
      shareCapital: 320000000, // $32 Million
      filingDate: new Date('2025-12-10'),
    },
    source: 'UAE Ministry of Economy',
    sourceUrl: 'https://www.moe.gov.ae/en/companies-registry/cn-330198-shj',
    confidence: 92,
  },
  {
    companyName: 'Ras Al Khaimah Manufacturing Industries LLC',
    registrationNumber: 'CN-552819-RAK',
    eventType: 'director_change',
    details: {
      directors: [
        { name: 'Hassan Al-Rashid', registryId: 'REG-009012' },
        { name: 'Mariam Al-Zahra', registryId: 'REG-010123' },
      ],
      shareCapital: 450000000, // $45 Million
      filingDate: new Date('2025-12-08'),
    },
    source: 'UAE Ministry of Economy',
    sourceUrl: 'https://www.moe.gov.ae/en/companies-registry/cn-552819-rak',
    confidence: 94,
  },
];

// ==============================================
// MOCK DATA: IPO EVENTS (DFM/ADX/Tadawul)
// ==============================================
...
export const mockIPOEvents: IPOEvent[] = [
  ...
  {
    companyName: 'GulfPay Payments Gateway Ltd',
    exchange: 'DFM',
...
export const mockNewsEvents: NewsEvent[] = [
  {
    companyName: 'Harbor Tech Solutions',
    headline: 'Harbor Tech Solutions raises $250M in Series B funding led by Mubadala Capital',
    summary: 'Dubai-based tech startup Harbor Tech Solutions announced today that it has raised $250 million in Series B funding, valuing the company at $1.2 billion. The round was led by Mubadala Capital with participation from existing investors.',
    source: 'Gulf News',
    publishedAt: new Date('2025-12-18T09:30:00Z'),
    url: 'https://gulfnews.com/business/harbor-tech-series-b',
    sentiment: 'positive',
    confidence: 75,
  },
  {
    companyName: 'Desert Solar Innovations',
    headline: 'Desert Solar Innovations secures $75M to expand solar operations',
    summary: 'Renewable energy startup Desert Solar Innovations has secured $75 million in Series A funding from Aramco Ventures and Gulf Capital to expand its solar panel manufacturing capacity.',
    source: 'The National',
    publishedAt: new Date('2025-12-17T14:15:00Z'),
    url: 'https://www.thenationalnews.com/business/energy/desert-solar-innovations-funding',
    sentiment: 'positive',
    confidence: 72,
  },
  {
    companyName: 'GulfPay Services',
    headline: 'GulfPay Services files for IPO, targets $500M raise',
    summary: 'Leading fintech company GulfPay Services has filed a prospectus with the CMA for an IPO worth $4,000 Million. The company plans to list on Tadawul by Q1 2026.',
    source: 'Zawya',
    publishedAt: new Date('2025-12-16T11:00:00Z'),
    url: 'https://www.zawya.com/en/markets/ipo/gulfpay-services-ipo-filing',
    sentiment: 'positive',
    confidence: 78,
  },
  {
    ...
    url: 'https://www.arabianbusiness.com/industries/real-estate/dubai-infra-board-changes',
    sentiment: 'neutral',
    confidence: 68,
  },
  {
    companyName: 'HealthTech Diagnostics ME',
    headline: 'HealthTech Diagnostics ME raises $180M in Series C, eyes regional expansion',
    summary: 'Digital diagnostics platform HealthTech Diagnostics ME announced a $180 million Series C funding round led by Gulf Capital. The funds will be used to expand to 50 new locations across the Middle East.',
    source: 'Saudi Gazette',
    publishedAt: new Date('2025-12-14T10:45:00Z'),
    url: 'https://saudigazette.com.sa/article/healthtech-diagnostics-series-c',
    sentiment: 'positive',
    confidence: 74,
  },
  {
    companyName: 'CloudTech Solutions Gulf',
    headline: 'CloudTech Solutions Gulf files prospectus for $1,200 Million IPO on DFM',
    summary: 'Cloud infrastructure provider CloudTech Solutions Gulf has filed a prospectus with the UAE SCA for an initial public offering worth $1,200 Million. The IPO is expected to open in February 2026.',
    source: 'Zawya',
    publishedAt: new Date('2025-12-17T08:20:00Z'),
    url: 'https://www.zawya.com/en/markets/ipo/cloudtech-solutions-gulf-prospectus',
    sentiment: 'positive',
    confidence: 80,
  },
];
...
export function getEventsByCompany(companyName: string): {
  ...
  return {
    ...
    registry: mockRegistryEvents.filter((e) =>
      e.companyName.toLowerCase().includes(companyName.toLowerCase())
    ),
