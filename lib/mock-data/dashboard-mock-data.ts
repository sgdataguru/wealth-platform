...
export const mockSuggestions: Suggestion[] = [
  {
    ...
    reasoning: 'Client\'s company filed a prospectus with the UAE SCA yesterday. Lock-in expires in 6 months, creating significant liquidity event opportunity.',
    actionButtons: [
...
export const mockAgendaItems: AgendaItem[] = [
  ...
  },
  {
    ...
    aiContextNote: 'First meeting. Referred by Hassan Al-Rashid. Tech entrepreneur, recent exit. Focus on wealth preservation.',
    status: 'pending',
    duration: 90,
  },
  {
