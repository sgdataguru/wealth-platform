...
export const mockSuggestions: Suggestion[] = [
  {
    ...
    clientId: 'client-001',
    clientContext: 'IPO filing next month, estimated ₹450 Cr liquidity event',
  ...
  },
  {
    ...
    clientId: 'client-002',
    clientContext: '₹85 Cr in savings account yielding 3.5%, missing 5% FD opportunity',
    suggestedAction: 'Propose ladder FD structure to optimize yield while maintaining liquidity',
    reasoning: 'Client has significant idle cash. Market FD rates at 7.5% represent ₹3.4 Cr/year additional income opportunity.',
    actionButtons: [
  ...
  },
  {
    ...
    clientId: 'client-003',
    clientContext: 'Zero gold allocation in ₹300 Cr portfolio, high INR cash exposure',
    suggestedAction: 'Propose 5% gold allocation via Sovereign Gold Bonds for portfolio diversification',
    reasoning: 'Portfolio heavily concentrated in equities (75%) and real estate (25%). Gold can provide INR hedge and diversification.',
    actionButtons: [
...
export const mockAlerts: Alert[] = [
  ...
  },
  {
    ...
    actionRequired: 'Client must add ₹12 Cr collateral or liquidate positions by EOD',
  ...
  },
  {
    ...
    actionRequired: 'Follow up on ₹50 Cr real estate deal before opportunity expires',
  ...
  },
  {
    ...
    clientId: 'client-010',
    details: 'Large cash deposit (₹2 Cr) flagged for enhanced due diligence',
...
export const mockAgendaItems: AgendaItem[] = [
  ...
  },
  {
    ...
    aiContextNote: 'First meeting. Referred by Vikram Malhotra. Tech entrepreneur, recent exit. Focus on wealth preservation.',
    status: 'pending',
    duration: 90,
  },
  {
    ...
    clientName: 'Kavita Deshmukh',
    clientId: 'client-008',
    location: 'Client Site - Worli',
    aiContextNote: 'Follow-up on ₹50 Cr Mumbai property opportunity. Bring updated valuation report and rental yield analysis.',
    status: 'pending',
    duration: 45,
  },
  {
...
export const mockMarketInsights: MarketInsight[] = [
  {
    ...
    headline: 'Nifty 50 Hits All-Time High on Strong FII Flows',
    context: 'Index gains 2.3% this week driven by banking and IT sector strength. FII inflows reach ₹12,000 Cr in December.',
  ...
  },
  {
    id: 'market-002',
    assetClass: 'currency',
    headline: 'USD/INR Weakens to 83.15 on RBI Intervention',
    context: 'Rupee strengthens 0.8% as RBI sells dollars to stabilize currency. Export-heavy sectors face headwinds.',
    portfolioSuggestion: 'Clients with USD exposure should consider partial hedging. Gold becomes relatively more attractive.',
    change: -0.8,
  ...
  },
  {
    ...
    headline: 'Mumbai Prime Real Estate Yields Compress to 3.2%',
    context: 'Luxury residential segment sees strong demand. Capital values up 8% YoY but rental yields declining.',
    portfolioSuggestion: '2 clients considering Mumbai property purchases. Recommend focus on appreciation over yield.',
    change: 8.0,
    changeDirection: 'up',
    lastUpdated: new Date(),
    isClientRelevant: true,
